...
This project was meant to scrape general college football data for each major college football team, and then dump that data into a CSV. The data will be used in another project posted shortly - I'll link that repo here once it's up. I scraped 15 years of data from 70 college football teams.
...
Anyways, keep an eye out for future college football analysis using this data!
